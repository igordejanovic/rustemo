...
pub(crate) static PARSER_DEFINITION: Calculator04AmbigLhsParserDefinition = Calculator04AmbigLhsParserDefinition {
    actions: [
        [
            Error,
            Error,
...
impl Calculator04AmbigLhsParser {
    pub fn parse_str<'i>(
        input: &'i str,
    ) -> Result<<Calculator04AmbigLhsBuilder as Builder>::Output> {
...
pub(crate) static LEXER_DEFINITION: Calculator04AmbigLhsLexerDefinition = Calculator04AmbigLhsLexerDefinition {
    terminals: [
        TerminalInfo {
            id: TermIndex(0usize),
            name: "STOP",
        ...
        let prod = match ProdKind::try_from(prod_kind.0).unwrap() {
            ProdKind::EAdd => {
                ...
                match (i.next().unwrap(), i.next().unwrap(), i.next().unwrap()) {
                    ...
                    ) => NonTerminal::E(calculator04_ambig_lhs_actions::e_add(p0, p1)),
            ...
            ProdKind::ESub => {
                ...
                match (i.next().unwrap(), i.next().unwrap(), i.next().unwrap()) {
                    (
                        ...
                        _,
                        Symbol::NonTerminal(NonTerminal::E(p1)),
                    ) => NonTerminal::E(calculator04_ambig_lhs_actions::e_sub(p0, p1)),
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ProdKind::EMul => {
                ...
                match (i.next().unwrap(), i.next().unwrap(), i.next().unwrap()) {
                    (
                        ...
                        _,
                        Symbol::NonTerminal(NonTerminal::E(p1)),
                    ) => NonTerminal::E(calculator04_ambig_lhs_actions::e_mul(p0, p1)),
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ProdKind::EDiv => {
                ...
                match (i.next().unwrap(), i.next().unwrap(), i.next().unwrap()) {
                    (
                        ...
                        _,
                        Symbol::NonTerminal(NonTerminal::E(p1)),
                    ) => NonTerminal::E(calculator04_ambig_lhs_actions::e_div(p0, p1)),
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ProdKind::EPow => {
                ...
                match (i.next().unwrap(), i.next().unwrap(), i.next().unwrap()) {
                    (
                        ...
                        _,
                        Symbol::NonTerminal(NonTerminal::E(p1)),
                    ) => NonTerminal::E(calculator04_ambig_lhs_actions::e_pow(p0, p1)),
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ProdKind::EParen => {
                ...
                match (i.next().unwrap(), i.next().unwrap(), i.next().unwrap()) {
                    (_, Symbol::NonTerminal(NonTerminal::E(p0)), _) => {
                        NonTerminal::E(calculator04_ambig_lhs_actions::e_paren(p0))
                    }
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ProdKind::ENum => {
                ...
                match i.next().unwrap() {
                    Symbol::Terminal(Terminal::Num(p0)) => {
                        NonTerminal::E(calculator04_ambig_lhs_actions::e_num(p0))
                    }
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
