/// Generated by rustemo on 2022-07-26 13:05:41.758802582 +02:00
...
pub struct Calculator1Parser<'i>(pub LRParser<&'i str, Calculator1ParserDefinition>);

impl<'i, L, B> Parser<L, B> for Calculator1Parser<'i>
where
    L: Lexer<Input = &'i str>,
    B: Builder<Lexer = L>
{
...
impl<'i> Calculator1Parser<'i> {
    pub fn parse_default(&mut self, lexer: Calculator1Lexer<'i>) -> E {
        let builder =
            Calculator1Builder::<'_, <Calculator1Lexer as Lexer>::Input>::new();
...
impl<'i> Default for Calculator1Parser<'i> {
    fn default() -> Self {
        Self(LRParser {
            context: LRContext {
...
pub struct Calculator1Lexer<'i>(DefaultLexer<'i, Calculator1LexerDefinition>);

impl<'i> Lexer for Calculator1Lexer<'i> {
    type Input = &'i str;
...
impl<'i, T> From<&'i T> for Calculator1Lexer<'i>
where
    T: AsRef<str> + ?Sized,
{
...
pub struct Calculator1Builder<'i, I: 'i> {
    res_stack: Vec<Symbol>,
    phantom: PhantomData<&'i I>
}

impl<'i, I> Builder for Calculator1Builder<'i, I>
{
    type Output = Symbol;
    type Lexer = Calculator1Lexer<'i>;
