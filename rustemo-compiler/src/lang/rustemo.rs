...
impl ParserDefinition<TokenRecognizer> for RustemoParserDefinition {
...
pub struct RustemoLayoutParser(LRParser<RustemoParserDefinition, TokenRecognizer>);
impl Default for RustemoLayoutParser {
    fn default() -> Self {
        Self(LRParser::new(&PARSER_DEFINITION, StateIndex(122usize), true))
    }
}
