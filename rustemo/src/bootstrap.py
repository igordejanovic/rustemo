...
if __name__ == '__main__':
    ...
    with open('rustemo.rs', 'w') as f:
        ...
        f.write('use rustemo_rt::lexer::{Lexer, DefaultLexer, Token, LexerDefinition, RecognizerIterator};\n')
        f.write('use rustemo_rt::lr::{LRParser, LRContext, ParserDefinition};\n')
        f.write('use rustemo_rt::lr::Action::{self, Shift, Reduce, Accept, Error};\n')
        ...
        f.write('        &self,\n')
        f.write('        context: &mut impl rustemo_rt::parser::Context<Self::Input>,\n')
        f.write('    ) -> Option<rustemo_rt::lexer::Token<Self::Input>> {\n')
