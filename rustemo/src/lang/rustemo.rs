...
impl TermKind {
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            TermKind::STOP => "STOP",
            TermKind::Terminals => "Terminals",
            TermKind::Import => "Import",
            TermKind::As => "As",
            TermKind::Colon => "Colon",
            TermKind::SemiColon => "SemiColon",
            TermKind::Comma => "Comma",
            TermKind::OBrace => "OBrace",
            TermKind::CBrace => "CBrace",
            TermKind::OBracket => "OBracket",
            TermKind::CBracket => "CBracket",
            TermKind::OSBracket => "OSBracket",
            TermKind::CSBracket => "CSBracket",
            TermKind::Choice => "Choice",
            TermKind::ZeroOrMore => "ZeroOrMore",
            TermKind::ZeroOrMoreGreedy => "ZeroOrMoreGreedy",
            TermKind::OneOrMore => "OneOrMore",
            TermKind::OneOrMoreGreedy => "OneOrMoreGreedy",
            TermKind::Optional => "Optional",
            TermKind::OptionalGreedy => "OptionalGreedy",
            TermKind::Equals => "Equals",
            TermKind::QEquals => "QEquals",
            TermKind::Left => "Left",
            TermKind::Right => "Right",
            TermKind::Reduce => "Reduce",
            TermKind::Shift => "Shift",
            TermKind::Dynamic => "Dynamic",
            TermKind::NOPS => "NOPS",
            TermKind::NOPSE => "NOPSE",
            TermKind::Prefer => "Prefer",
            TermKind::Finish => "Finish",
            TermKind::NoFinish => "NoFinish",
            TermKind::OComment => "OComment",
            TermKind::CComment => "CComment",
            TermKind::Name => "Name",
            TermKind::RegexTerm => "RegexTerm",
            TermKind::IntConst => "IntConst",
            TermKind::FloatConst => "FloatConst",
            TermKind::BoolConst => "BoolConst",
            TermKind::StrConst => "StrConst",
            TermKind::Action => "Action",
            TermKind::WS => "WS",
            TermKind::CommentLine => "CommentLine",
            TermKind::NotComment => "NotComment",
        }
    }
}
impl From<TermIndex> for TermKind {
    fn from(term_index: TermIndex) -> Self {
        match term_index.0 {
            0usize => TermKind::STOP,
            1usize => TermKind::Terminals,
            2usize => TermKind::Import,
            3usize => TermKind::As,
            4usize => TermKind::Colon,
            5usize => TermKind::SemiColon,
            6usize => TermKind::Comma,
            7usize => TermKind::OBrace,
            8usize => TermKind::CBrace,
            9usize => TermKind::OBracket,
            10usize => TermKind::CBracket,
            11usize => TermKind::OSBracket,
            12usize => TermKind::CSBracket,
            13usize => TermKind::Choice,
            14usize => TermKind::ZeroOrMore,
            15usize => TermKind::ZeroOrMoreGreedy,
            16usize => TermKind::OneOrMore,
            17usize => TermKind::OneOrMoreGreedy,
            18usize => TermKind::Optional,
            19usize => TermKind::OptionalGreedy,
            20usize => TermKind::Equals,
            21usize => TermKind::QEquals,
            22usize => TermKind::Left,
            23usize => TermKind::Right,
            24usize => TermKind::Reduce,
            25usize => TermKind::Shift,
            26usize => TermKind::Dynamic,
            27usize => TermKind::NOPS,
            28usize => TermKind::NOPSE,
            29usize => TermKind::Prefer,
            30usize => TermKind::Finish,
            31usize => TermKind::NoFinish,
            32usize => TermKind::OComment,
            33usize => TermKind::CComment,
            34usize => TermKind::Name,
            35usize => TermKind::RegexTerm,
            36usize => TermKind::IntConst,
            37usize => TermKind::FloatConst,
            38usize => TermKind::BoolConst,
            39usize => TermKind::StrConst,
            40usize => TermKind::Action,
            41usize => TermKind::WS,
            42usize => TermKind::CommentLine,
            43usize => TermKind::NotComment,
            _ => unreachable!(),
        }
    }
}
