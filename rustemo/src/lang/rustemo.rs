...
pub enum ProdKind {
    FileP1 = 1usize,
    GrammarRule1P1 = 2usize,
    GrammarRule1P2 = 3usize,
    FileP2 = 4usize,
    ImportStm1P1 = 5usize,
    ImportStm1P2 = 6usize,
    FileP3 = 7usize,
    TerminalRule1P1 = 8usize,
    TerminalRule1P2 = 9usize,
    FileP4 = 10usize,
    FileP5 = 11usize,
    ImportStmP1 = 12usize,
    ImportStmP2 = 13usize,
    GrammarRuleP1 = 14usize,
    ActionOptP1 = 15usize,
    ActionOptP2 = 16usize,
    GrammarRuleP2 = 17usize,
    GrammarRuleRHSP1 = 18usize,
    GrammarRuleRHSP2 = 19usize,
    ProductionP1 = 20usize,
    Assignment1P1 = 21usize,
    Assignment1P2 = 22usize,
    ProductionP2 = 23usize,
    TerminalRuleP1 = 24usize,
    TerminalRuleP2 = 25usize,
    TerminalRuleP3 = 26usize,
    TerminalRuleP4 = 27usize,
    ProdMetaDataLeft = 28usize,
    ProdMetaDataReduce = 29usize,
    ProdMetaDataRight = 30usize,
    ProdMetaDataShift = 31usize,
    ProdMetaDataDynamic = 32usize,
    ProdMetaDataNOPS = 33usize,
    ProdMetaDataNOPSE = 34usize,
    ProdMetaDataPriority = 35usize,
    ProdMetaDataP9 = 36usize,
    ProdMetaDataP10 = 37usize,
    ProdMetaDatasP1 = 38usize,
    ProdMetaDatasP2 = 39usize,
    TermMetaDataPrefer = 40usize,
    TermMetaDataFinish = 41usize,
    TermMetaDataNoFinish = 42usize,
    TermMetaDataDynamic = 43usize,
    TermMetaDataPriority = 44usize,
    TermMetaDataP6 = 45usize,
    TermMetaDatasP1 = 46usize,
    TermMetaDatasP2 = 47usize,
    UserMetaDataP1 = 48usize,
    ProdKindP1 = 49usize,
    ConstValP1 = 50usize,
    ConstValP2 = 51usize,
    ConstValP3 = 52usize,
    ConstValP4 = 53usize,
    AssignmentP1 = 54usize,
    AssignmentP2 = 55usize,
    AssignmentP3 = 56usize,
    PlainAssignmentP1 = 57usize,
    BoolAssignmentP1 = 58usize,
    ProductionGroupP1 = 59usize,
    GrammarSymbolRefP1 = 60usize,
    RepetitionOperatorOptP1 = 61usize,
    RepetitionOperatorOptP2 = 62usize,
    GrammarSymbolRefP2 = 63usize,
    RepetitionOperatorP1 = 64usize,
    RepetitionModifiersOptP1 = 65usize,
    RepetitionModifiersOptP2 = 66usize,
    RepetitionOperatorOpZeroOrMore = 67usize,
    RepetitionOperatorOpZeroOrMoreGreedy = 68usize,
    RepetitionOperatorOpOneOrMore = 69usize,
    RepetitionOperatorOpOneOrMoreGreedy = 70usize,
    RepetitionOperatorOpOptional = 71usize,
    RepetitionOperatorOpOptionalGreedy = 72usize,
    RepetitionModifiersP1 = 73usize,
    RepetitionModifier1P1 = 74usize,
    RepetitionModifier1P2 = 75usize,
...
pub(crate) static PARSER_DEFINITION: RustemoParserDefinition = RustemoParserDefinition {
    actions: [
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(16usize), 0usize, NonTermIndex(8usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(15usize), 1usize, NonTermIndex(8usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            Reduce(ProdIndex(11usize), 2usize, NonTermIndex(2usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            Reduce(ProdIndex(9usize), 1usize, NonTermIndex(5usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            Error,
            Error,
            Reduce(ProdIndex(12usize), 2usize, NonTermIndex(6usize), "<?>"),
        ...
        [
            Reduce(ProdIndex(4usize), 2usize, NonTermIndex(2usize), "<?>"),
        ...
        [
            Error,
            Error,
            Reduce(ProdIndex(5usize), 2usize, NonTermIndex(4usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            Reduce(ProdIndex(8usize), 2usize, NonTermIndex(5usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            Reduce(ProdIndex(7usize), 3usize, NonTermIndex(2usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            Error,
            Error,
            Reduce(ProdIndex(13usize), 4usize, NonTermIndex(6usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            Reduce(ProdIndex(10usize), 4usize, NonTermIndex(2usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(19usize), 1usize, NonTermIndex(9usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(22usize), 1usize, NonTermIndex(11usize), "<?>"),
            Error,
            Reduce(ProdIndex(22usize), 1usize, NonTermIndex(11usize), "<?>"),
            Error,
            Reduce(ProdIndex(22usize), 1usize, NonTermIndex(11usize), "<?>"),
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(55usize), 1usize, NonTermIndex(20usize), "<?>"),
            Error,
            Reduce(ProdIndex(55usize), 1usize, NonTermIndex(20usize), "<?>"),
            Error,
            Reduce(ProdIndex(55usize), 1usize, NonTermIndex(20usize), "<?>"),
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(62usize), 0usize, NonTermIndex(25usize), "<?>"),
            Error,
            Reduce(ProdIndex(62usize), 0usize, NonTermIndex(25usize), "<?>"),
            Error,
            Reduce(ProdIndex(62usize), 0usize, NonTermIndex(25usize), "<?>"),
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(28usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Reduce(ProdIndex(28usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(30usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Reduce(ProdIndex(30usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(29usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Reduce(ProdIndex(29usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(31usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Reduce(ProdIndex(31usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(32usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Reduce(ProdIndex(32usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(33usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Reduce(ProdIndex(33usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(34usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Reduce(ProdIndex(34usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(35usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Reduce(ProdIndex(35usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(36usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Reduce(ProdIndex(36usize), 1usize, NonTermIndex(13usize), "<?>"),
            Error,
            Error,
        ...
        [
            Reduce(ProdIndex(25usize), 4usize, NonTermIndex(12usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            Reduce(ProdIndex(14usize), 5usize, NonTermIndex(7usize), "<?>"),
            Reduce(ProdIndex(14usize), 5usize, NonTermIndex(7usize), "<?>"),
            Error,
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(21usize), 2usize, NonTermIndex(11usize), "<?>"),
            Error,
            Reduce(ProdIndex(21usize), 2usize, NonTermIndex(11usize), "<?>"),
            Error,
            Reduce(ProdIndex(21usize), 2usize, NonTermIndex(11usize), "<?>"),
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(67usize), 1usize, NonTermIndex(28usize), "<?>"),
            Error,
            Reduce(ProdIndex(67usize), 1usize, NonTermIndex(28usize), "<?>"),
            Error,
            Reduce(ProdIndex(67usize), 1usize, NonTermIndex(28usize), "<?>"),
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(68usize), 1usize, NonTermIndex(28usize), "<?>"),
            Error,
            Reduce(ProdIndex(68usize), 1usize, NonTermIndex(28usize), "<?>"),
            Error,
            Reduce(ProdIndex(68usize), 1usize, NonTermIndex(28usize), "<?>"),
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(69usize), 1usize, NonTermIndex(28usize), "<?>"),
            Error,
            Reduce(ProdIndex(69usize), 1usize, NonTermIndex(28usize), "<?>"),
            Error,
            Reduce(ProdIndex(69usize), 1usize, NonTermIndex(28usize), "<?>"),
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(70usize), 1usize, NonTermIndex(28usize), "<?>"),
            Error,
            Reduce(ProdIndex(70usize), 1usize, NonTermIndex(28usize), "<?>"),
            Error,
            Reduce(ProdIndex(70usize), 1usize, NonTermIndex(28usize), "<?>"),
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(71usize), 1usize, NonTermIndex(28usize), "<?>"),
            Error,
            Reduce(ProdIndex(71usize), 1usize, NonTermIndex(28usize), "<?>"),
            Error,
            Reduce(ProdIndex(71usize), 1usize, NonTermIndex(28usize), "<?>"),
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(72usize), 1usize, NonTermIndex(28usize), "<?>"),
            Error,
            Reduce(ProdIndex(72usize), 1usize, NonTermIndex(28usize), "<?>"),
            Error,
            Reduce(ProdIndex(72usize), 1usize, NonTermIndex(28usize), "<?>"),
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(63usize), 2usize, NonTermIndex(24usize), "<?>"),
            Error,
            Reduce(ProdIndex(63usize), 2usize, NonTermIndex(24usize), "<?>"),
            Error,
            Reduce(ProdIndex(63usize), 2usize, NonTermIndex(24usize), "<?>"),
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(61usize), 1usize, NonTermIndex(25usize), "<?>"),
            Error,
            Reduce(ProdIndex(61usize), 1usize, NonTermIndex(25usize), "<?>"),
            Error,
            Reduce(ProdIndex(61usize), 1usize, NonTermIndex(25usize), "<?>"),
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(66usize), 0usize, NonTermIndex(27usize), "<?>"),
            Error,
            Reduce(ProdIndex(66usize), 0usize, NonTermIndex(27usize), "<?>"),
            Error,
            Reduce(ProdIndex(66usize), 0usize, NonTermIndex(27usize), "<?>"),
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(43usize), 1usize, NonTermIndex(15usize), "<?>"),
            Error,
            Reduce(ProdIndex(43usize), 1usize, NonTermIndex(15usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(41usize), 1usize, NonTermIndex(15usize), "<?>"),
            Error,
            Reduce(ProdIndex(41usize), 1usize, NonTermIndex(15usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(42usize), 1usize, NonTermIndex(15usize), "<?>"),
            Error,
            Reduce(ProdIndex(42usize), 1usize, NonTermIndex(15usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(44usize), 1usize, NonTermIndex(15usize), "<?>"),
            Error,
            Reduce(ProdIndex(44usize), 1usize, NonTermIndex(15usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(47usize), 1usize, NonTermIndex(16usize), "<?>"),
            Error,
            Reduce(ProdIndex(47usize), 1usize, NonTermIndex(16usize), "<?>"),
            Error,
            Error,
        ...
        [
            Reduce(ProdIndex(24usize), 5usize, NonTermIndex(12usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(18usize), 3usize, NonTermIndex(9usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(64usize), 2usize, NonTermIndex(26usize), "<?>"),
            Error,
            Reduce(ProdIndex(64usize), 2usize, NonTermIndex(26usize), "<?>"),
            Error,
            Reduce(ProdIndex(64usize), 2usize, NonTermIndex(26usize), "<?>"),
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(51usize), 1usize, NonTermIndex(19usize), "<?>"),
            Error,
            Reduce(ProdIndex(51usize), 1usize, NonTermIndex(19usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(48usize), 3usize, NonTermIndex(17usize), "<?>"),
            Error,
            Reduce(ProdIndex(48usize), 3usize, NonTermIndex(17usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(38usize), 3usize, NonTermIndex(14usize), "<?>"),
            Error,
            Reduce(ProdIndex(38usize), 3usize, NonTermIndex(14usize), "<?>"),
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(23usize), 4usize, NonTermIndex(10usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            Reduce(ProdIndex(27usize), 7usize, NonTermIndex(12usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
        ...
        [
            ...
            Error,
            Error,
            Reduce(ProdIndex(73usize), 3usize, NonTermIndex(29usize), "<?>"),
            Error,
            Reduce(ProdIndex(73usize), 3usize, NonTermIndex(29usize), "<?>"),
            Error,
            Reduce(ProdIndex(73usize), 3usize, NonTermIndex(29usize), "<?>"),
        ...
        [
            Reduce(ProdIndex(17usize), 8usize, NonTermIndex(7usize), "<?>"),
            Reduce(ProdIndex(17usize), 8usize, NonTermIndex(7usize), "<?>"),
            Error,
            Error,
            Error,
        ...
        [
            Reduce(ProdIndex(26usize), 8usize, NonTermIndex(12usize), "<?>"),
            Error,
            Error,
            Error,
            Error,
