/// Generated by rustemo on 2022-08-01 18:14:27.603105099 +02:00
    ...
    fn reduce_action(&mut self, prod_kind: ProdIndex, _prod_len: usize, _prod_str: &'static str) {
        let prod = match ProdKind::try_from(prod_kind.0).unwrap() {
            ...
            ProdKind::ProdMetaDataP0 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::ProdMetaData(rustemo_actions::prod_meta_data_p0())
            }
            ProdKind::ProdMetaDataP1 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::ProdMetaData(rustemo_actions::prod_meta_data_p1())
            }
            ProdKind::ProdMetaDataP2 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::ProdMetaData(rustemo_actions::prod_meta_data_p2())
            }
            ProdKind::ProdMetaDataP3 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::ProdMetaData(rustemo_actions::prod_meta_data_p3())
            }
            ProdKind::ProdMetaDataP4 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::ProdMetaData(rustemo_actions::prod_meta_data_p4())
            }
            ProdKind::ProdMetaDataP5 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::ProdMetaData(rustemo_actions::prod_meta_data_p5())
            }
            ProdKind::ProdMetaDataP6 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::ProdMetaData(rustemo_actions::prod_meta_data_p6())
            }
            ...
            ProdKind::TermMetaDataP0 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::TermMetaData(rustemo_actions::term_meta_data_p0())
            }
            ProdKind::TermMetaDataP1 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::TermMetaData(rustemo_actions::term_meta_data_p1())
            }
            ProdKind::TermMetaDataP2 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::TermMetaData(rustemo_actions::term_meta_data_p2())
            }
            ProdKind::TermMetaDataP3 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::TermMetaData(rustemo_actions::term_meta_data_p3())
            }
            ...
            ProdKind::RepetitionOperatorOpP0 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::RepetitionOperatorOp(rustemo_actions::repetition_operator_op_p0())
            }
            ProdKind::RepetitionOperatorOpP1 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::RepetitionOperatorOp(rustemo_actions::repetition_operator_op_p1())
            }
            ProdKind::RepetitionOperatorOpP2 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::RepetitionOperatorOp(rustemo_actions::repetition_operator_op_p2())
            }
            ProdKind::RepetitionOperatorOpP3 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::RepetitionOperatorOp(rustemo_actions::repetition_operator_op_p3())
            }
            ProdKind::RepetitionOperatorOpP4 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::RepetitionOperatorOp(rustemo_actions::repetition_operator_op_p4())
            }
            ProdKind::RepetitionOperatorOpP5 => {
                let _ = self.res_stack.split_off(self.res_stack.len()-1).into_iter();
                NonTerminal::RepetitionOperatorOp(rustemo_actions::repetition_operator_op_p5())
            }
