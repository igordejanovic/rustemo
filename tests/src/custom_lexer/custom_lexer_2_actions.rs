...
pub type MSBByte = u8;
pub fn msbbyte<'i>(token: Token<'i>) -> MSBByte {
    token.value[0]
}
pub type NonMSBByte = u8;
pub fn non_msbbyte<'i>(token: Token<'i>) -> NonMSBByte {
    token.value[0]
}
...
pub fn msbbyte1_c1(mut msbbyte1: MSBByte1, msbbyte: MSBByte) -> MSBByte1 {
    msbbyte1.push(msbbyte);
    msbbyte1
}
pub fn msbbyte1_c2(msbbyte: MSBByte) -> MSBByte1 {
    vec![msbbyte]
}
pub type MSBByte0 = Option<MSBByte1>;
pub fn msbbyte0_c1(msbbyte1: MSBByte1) -> MSBByte0 {
    Some(msbbyte1)
}
pub fn msbbyte0_empty() -> MSBByte0 {
    None
}
