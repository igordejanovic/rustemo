...
#[test]
fn zero_or_more_2_1() {
    let result = ZeroOrMore2Parser::parse_str("c 1 2 3 a");
    output_cmp!(
...
#[test]
fn zero_or_more_2_2() {
    let result = ZeroOrMore2Parser::parse_str("c a");
    output_cmp!(
...
fn zero_or_more_2_1_error() {
    let result = ZeroOrMore2Parser::parse_str("c c a");
    output_cmp!(
...
fn zero_or_more_2_2_error() {
    let result = ZeroOrMore2Parser::parse_str("c 1 2 a a");
    output_cmp!(
